...
void loop() {
  ...
  Firebase.setFloat("Sonardata/Soner1", d1);
  if (Firebase.failed()) {
  ...
  if(fail == 0)
  {
    Firebase.setFloat("Sonardata/Soner2", d2);
...
// Path calculation
  String today = "device1/today/" + String(hour) + "/number";
  String todayTime = "device1/today/" + String(hour) + "/time";
  String todayDate = "device1/today/" + String(hour) + "/date";
  
  String historyNumber = "device1/history/" + date + "/number";
  String historyTime = "device1/history/" + date + "/time";
  String historyDate = "device1/history/" + date + "/date";
